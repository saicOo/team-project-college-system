...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">قائمة عرض جيمع الطلاب المقيدين والغير مقيدين</li>
    </ol>
</div>
                            ...
                            <div class="modal-content">
                                ...
                                <form class="form-horizontal" action="{{route('students.search', 0)}}" enctype="multipart/form-data" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                                <label for="1">تم القيد</label>
                                                <input type="checkbox" class="ml-3" id="1" name="paid">
                                                <label for="2">لم يتم القيد</label>
                        ...
                        <tbody>
                            @foreach ($students as $std)
                                <tr>
                                    ...
                                    <td>
                                        @if($std->status)
                                            <span class="badge badge-success m-b-5">مقيد</span>
                                        @else
                                            <span class="badge badge-danger m-b-5">غير مقيد</span>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
