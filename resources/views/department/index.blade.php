...
<div class="content-wrapper">
            ...
            <div class="page-heading">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">هذه الاقسام هى المتاحة لدينا بكلية التجارة الانجليزى كما يمكنك ايضا اضافة قسم جديد فى حالة ان يتم اعتماده من قبل عميد الكليه بالشروط المتفق عليها  </li>
                                            ...
                                            @csrf
                                                <div class="modal-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control text-right" type="text" name="dept_name"
                                                                placeholder=" ادخل اسم القسم ولايمكن ان يكون متشابه مع اسم قسم اخر" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">عدد الطلاب</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control text-right" type="text" name="dept_capacity_num"
                                                                placeholder="ادخل عدد الطلاب" required> 
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control text-right" type="text" name="minimum_degree"
                                                ...
                                                <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control text-right" type="text" name="minimum_degree_en"
                                                                placeholder="ادخل درجة اللغة الأنجليزية بحد اقصى 60 درجة" required>
                                                        </div>
                                                    </div>
                                                </div>
