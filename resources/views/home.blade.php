...
@section('content')
    ...
    <div id="home" class="hero-area">
        ...
        <div class="home-wrapper">
            <div class="container">
                <div class="row">
                    @if (null !== Auth::user() && Auth::user()->status == 0)
                        <div class="col-md-8">
                            <h1 class="white-text">اكمل تسجيل بياناتك !</h1>
                            <p class="lead white-text">اكمل عملية تسجيل البيانات الشخصية و اختيار الرغبات للألتحاق بالقسم
                                المناسب لك .</p>
                            <a class="main-button icon-button" href="{{ url('step1') }}"> تسجيل البيانات!</a>
                        </div>
                    @elseif (null !== Auth::user() && Auth::user()->status == 1)
                        <div class="col-md-8">
                            <h1 class="white-text">مرحبا بك يا {{ Auth::user()->name }}</h1>
                    ...
                    @else
                        <div class="col-md-8">
                            ...
                            <p class="lead white-text">تلتزم كلية التجارة بتقديم خدمات التعليم والبحوث والاستشارات والتدريب
                                ...
                                المال البشرى مع تحقيق الشراكة المحلية والعالمية الفعالة، وذلك سعياً نحو خدمه المجتمع وبيئة
                                الأعمال</p>
                            <a class="main-button icon-button" href="{{ route('login') }}">سجل الان!</a>
                        </div>
                    @endif
                </div>
            </div>
