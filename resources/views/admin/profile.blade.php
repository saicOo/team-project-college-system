...
@section('content')
                ...
                <div class="ibox">
                    <div class="ibox-body">
                        ...
                        <ul class="nav nav-tabs tabs-line">
                            ...
                            @if (Auth::user()->role == 0 || Auth::user()->id == $admin->id)
                                <li class="nav-item">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    <button type="button" class="btn btn-warning border text-light"
                                                        ...
                                                        title="update password" data-target="#updatePassword">
                                                        تعديل الرقم السري
                                                    </button>
                                                </div>
                                            </div>
    ...
    @if (Auth::user()->role == 0 || Auth::user()->id == $admin->id)
        ...
        <div class="modal fade" id="updatePassword" tabindex="-1" aria-labelledby="addDepartmentLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form class="form-horizontal" action="{{ route('admin.update', $admin->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">اعد كتابة الرقم
                                    السري</label>
